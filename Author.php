...
class Author{
    ...
    public static function CreateAuthor($fnameform, $snameform, $emailform, $usernameform, $passwordform, $conn) {
        $author = new Author($fnameform, $snameform, $emailform, $usernameform, $passwordform);
    ...
    public function saveToDatabase(){
        ...
        $sql=("INSERT INTO `Author` (`AuthorID`, `Fname`, `Sname`, `Email`, `Username`, `Password`) VALUES (NULL, '$getF', '$getL', '$getE', '$getU', '$getP')");
